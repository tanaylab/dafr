...
[`zip_daf()`](https://tanaylab.github.io/dafr/reference/zip_daf.md) for
writable modes (`"r+"`, `"w"`, `"w+"`). The archive is append-only. Use
[`zip_daf()`](https://tanaylab.github.io/dafr/reference/zip_daf.md) to
construct instances.

...
- [`HttpDaf()`](https://tanaylab.github.io/dafr/reference/HttpDaf.md)
  [`http_daf()`](https://tanaylab.github.io/dafr/reference/HttpDaf.md) :
  Read-only HTTP-served FilesDaf.

- [`ZipDaf()`](https://tanaylab.github.io/dafr/reference/ZipDaf.md) :
  File-backed (zip) Daf writer class.

- [`ZipDafReadOnly()`](https://tanaylab.github.io/dafr/reference/ZipDafReadOnly.md)
...
- [`new_http_store()`](https://tanaylab.github.io/dafr/reference/new_http_store.md)
  : Construct a read-only ZarrStore over HTTP (Zarr v3).
- [`HttpStore()`](https://tanaylab.github.io/dafr/reference/HttpStore.md)
...
- [`complete_chain()`](https://tanaylab.github.io/dafr/reference/complete_chain.md)
  ...
  Create a persistent chain by linking `new_daf` to its base
  repositories.

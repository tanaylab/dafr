...
mmap_real_altrep_cpp <- function(path, length_double, offset_double) {
  .Call(`_dafr_mmap_real_altrep_cpp`, path, length_double, offset_double)
}

mmap_int_altrep_cpp <- function(path, length_double, offset_double) {
  .Call(`_dafr_mmap_int_altrep_cpp`, path, length_double, offset_double)
}

mmap_lgl_altrep_cpp <- function(path, length_double, offset_double) {
  .Call(`_dafr_mmap_lgl_altrep_cpp`, path, length_double, offset_double)
}
